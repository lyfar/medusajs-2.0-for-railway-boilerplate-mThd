...
## Exclusions & Optional Packages

- **Exclusions (Initial Visual Identity)**: Packaging, print materials (business cards, stationery) are not included.
- **Optional Packages**:
  - **Digital Branding Package**: 90,000 HKD — Full brand system for digital, extended guidelines, UI kit.
  - **Full Branding Package**: 150,000 HKD — Everything in Digital + packaging, print collateral, production oversight.
