    ...
    async function fetchProducts() {
      ...
      try {
        ...
        const filtered = all.filter((p) => {
          ...
          if (t.includes("white")) return true
          const m = p.metadata || {}
          return m.is_white_diamond === true || m.is_white_diamond === "true"
        })
        ...
        // Extra columns from any metadata keys on current page
        const reserved = new Set(["metadata_template", "metadata_template_json"])
    ...
    <>
      <Container className="divide-y p-0">
        <div className="flex items-center justify-between px-6 py-4">
          <Heading level="h2">White Diamonds</Heading>
...
export default WhiteDiamondsPage
